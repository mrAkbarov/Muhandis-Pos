...
export const ROUTE_ROLES = {
  ...
  '/platform/magazinlar': [ROLES.ADMIN],
};

export function canAccessRoute(role, pathname, isGlobalAdmin = false) {
  if (!role) return false;
  if (pathname === '/platform/magazinlar') {
